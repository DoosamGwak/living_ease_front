  ...
  return (
    <>
      ...
      <div className={cx("pet-family", "unimg")}>
        ...
        <div className={cx("pet-title")}>PET(반려동물) + FAMILY(가족)</div>
        <hr />
      ...
      <div className={cx("pet-family", "img2", "section")}></div>
      ...
      <div className={cx("content")}>
        ...
        <div className={cx("main-content", "community")} id="community">
          <div className={cx("section")}>
            <div className={cx("intro-head")}>
              <h3>산책 메이트,</h3>
              <h3>펫밀리 커뮤니티에서 같이 산책할 친구를 찾아봐요</h3>
              <p>반려동물을 사랑하는 사람들과의 소통.</p>
              <p>펫밀리 커뮤니티에서 반려동물의 친구를 만들어보세요.</p>
              <hr />
            </div>
